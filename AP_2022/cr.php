        ...
        while($donnees = mysqli_fetch_assoc($resultat))
          {
            ...
            echo "<table border=2><thead> <tr> <th colspan=2> <u>n°$num</u> </th> </tr> </thead><tbody> <tr> <td> CONTENU : $contenu</td> </tr><tr> <td>NOTE : $note</td> </tr><tr> <td> <a href='modif.php?id=$num'>Modifier</a> </td> </tr> </tbody> </table> <br>";
 ?>
        ...
        while($donnees = mysqli_fetch_assoc($resultat))
          {
            ...
            echo "<table border=2><thead> <tr> <th colspan=2> <u>n°$num</u> </th> </tr> </thead><tbody> <tr> <td> CONTENU : $contenu</td> </tr><tr> <td>NOTE : $note</td> </tr><tr> <td> <a href='modif.php?id=$num'>Modifier</a> </td> </tr> </tbody> </table> <br>";  //affiche tous les compte rendus du plus recent au plus ancien + lien pour modifier
