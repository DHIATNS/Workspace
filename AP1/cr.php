...
<?php
     if($connexion = mysqli_connect($serveurBDD,$userBDD,$mdpBDD,$nomBDD))
      {
        $id=$_SESSION["id"];     
        $requete="SELECT * FROM cr,utilisateur WHERE utilisateur.num = cr.num_utilisateur ORDER BY date DESC"; //recupere tous les comptes rendus par date decroissante
        ...
        while($donnees = mysqli_fetch_assoc($resultat))
          {
            ...
            <tbody> <tr> <td>  $contenu</td> </tr> <tr> <td>note $note/5 </td> </tr>  <tr> <td></td> </tr> </tbody> </table> <br>";  //affiche tous les compte rendus du plus recent au plus ancien + lien pour modifier
          }
    }
 ?>
<?php 
